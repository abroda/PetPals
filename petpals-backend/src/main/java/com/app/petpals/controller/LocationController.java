...
public class LocationController {
     ...
     * Maps to "/petpals/location" due to the application destination prefix "/petpals".
     */
    ...
    public void handleLocationUpdate(LocationMessage locationMessage, Principal principal) {
        ...
        String userId = principal.getName(); // The authenticated user's username
        ...
        // Send the list of nearby users back to the sender using "/location/nearby"
        // Spring will resolve "/user/{userId}/location/nearby"
//        messagingTemplate.convertAndSendToUser(locationMessage.getUserId(), "/location/nearby", nearbyUsers);
