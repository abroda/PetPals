...
import {SafeAreaView, Pressable, View, Text, Alert, FlatList, ScrollView} from "react-native";
...
export default function PetProfileScreen() {
    ...
    const dogTags = ["playful", "dog-friendly", "reserved" , "puppy", "well-mannered" ]
    const renderDogTag = ({ item }) => (
        <DogTag tag={item}/>
    );
