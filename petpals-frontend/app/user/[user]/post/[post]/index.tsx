    ...
    <SafeAreaView style={{ height: "100%" }}>
      ...
      >
        ...
        >
          ...
          >
            Oh what a great description! Surely written by a genius. Also look
            at this cute doggo.
          </ThemedText>
      ...
      {/*                        textStyleOptions={{size: "big"}}>Username</ThemedText>*/}
      {/*        </HorizontalView>*/}
      ...
      {/*                    textStyleOptions={{size: "big"}}>Example post with*/}
      {/*            a cutie</ThemedText>*/}
      {/*        <ThemedText style={{backgroundColor: "transparent", marginBottom: percentToDP(5)}}*/}
      {/*                    textStyleOptions={{size: "small"}}>Oh what a great description! Surely written by a genius. Also look*/}
      {/*            at this*/}
      ...
      {/*            }}*/}
      {/*        />*/}
      {/*        <ThemedText style={{backgroundColor: "transparent"}} textStyleOptions={{size: "big"}}>3</ThemedText>*/}
      {/*    </HorizontalView>*/}
      {/*    <HorizontalView justifyOption={"flex-end"} style={{alignItems: "center"}}>*/}
      {/*        <Pressable onPress={() => setLiked(!liked)}>*/}
      {/*            <ThemedIcon*/}
      ...
      {/*            />*/}
      {/*        </Pressable>*/}
      {/*        <ThemedText style={{backgroundColor: "transparent"}} textStyleOptions={{size: "small"}}>21</ThemedText>*/}
      {/*    </HorizontalView>*/}
      {/*</HorizontalView>*/}
