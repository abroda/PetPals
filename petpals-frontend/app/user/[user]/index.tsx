...
export default function UserProfileScreen() {
            ...
            <View style={{
                ...
                <HorizontalView justifyOption="space-evenly" style={{
                    ...
                    <View style={{ alignItems: 'center' }}>
                        <ThemedText style={{ fontSize: 24, fontWeight: "bold", color: cream }}>21</ThemedText>
                        <ThemedText style={{ fontSize: 12, color: cream }}>friends</ThemedText>
                    </View>
                    <View style={{ alignItems: 'center' }}>
                        <ThemedText style={{ fontSize: 24, fontWeight: "bold", color: cream }}>2</ThemedText>
                        <ThemedText style={{ fontSize: 12, color: cream }}>km this week</ThemedText>
                    </View>
                    <View style={{ alignItems: 'center' }}>
                        <ThemedText style={{ fontSize: 24, fontWeight: "bold", color: cream }}>21</ThemedText>
    ...
    return (
            <SafeAreaView style={{ flex: 1, width: widthPercentageToDP(100), backgroundColor: lightGreen }}>
                <FlatList
                    style={{
                        width: widthPercentageToDP(100),
                    }}
                    ...
                    ListFooterComponent={() => (
                        <>
                            <ThemedText style={{ fontSize: 30, color: cream, marginLeft: widthPercentageToDP(5), marginTop: heightPercentToPD(4) }}>Posts</ThemedText>
                            <PostFeed />
                        </>
                    )}
                />
                {menuVisible && (
                    <View style={{
                        ...
                        <Pressable onPress={() => handleMenuSelect("Edit")}>
                            <Text style={{ padding: 20, color: cream, borderBottomWidth: 1, borderColor: accentGreen, fontSize: 18 }}>Edit</Text>
                        </Pressable>
                        <Pressable onPress={() => handleMenuSelect("App Settings")}>
                            <Text style={{ padding: 20, color: cream, fontSize: 18 }}>App Settings</Text>
                        </Pressable>
                    </View>
                )}
            </SafeAreaView>
